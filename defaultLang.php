<?php
	...
	$Translation['forgot password']="Olvido su contraseña? <a href=membership_passwordReset.php>Click here</a>";
	...
	// checkMemberID.php
	$Translation['user already exists']="Este nombre de usuario '<MemberID>' ya existe. Intente otro.";
	$Translation['user available']="Nombre de usuario correcto '<MemberID>' puede usarlo.";
	...
	$Translation['Change owner of <n> selected records to'] = 'Cambio de propietario de <n> registros seleccionados para';
	...
	$Translation['permalink'] = 'Enlace permanente';
	$Translation['invalid provider'] = 'Proveedor no válido';
	$Translation['invalid url'] = 'Invalida URL!';
