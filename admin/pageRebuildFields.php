<?php
	...
	$schema = array(   
		...
		'medical_records' => array(   
			...
			'image_1' => array('appgini' => 'VARCHAR(40) '),
			'image_2' => array('appgini' => 'VARCHAR(40) '),
			'image_3' => array('appgini' => 'VARCHAR(40) '),
			'image_4' => array('appgini' => 'VARCHAR(40) '),
			'image_5' => array('appgini' => 'VARCHAR(40) '),
			'document_1' => array('appgini' => 'VARCHAR(40) '),
			'document_2' => array('appgini' => 'VARCHAR(40) '),
			'document_3' => array('appgini' => 'VARCHAR(40) '),
			'document_4' => array('appgini' => 'VARCHAR(40) '),
			'document_5' => array('appgini' => 'VARCHAR(40) '),
		...
		'events' => array(   
			...
			'name_patient' => array('appgini' => 'INT unsigned '),
			'time' => array('appgini' => 'TIME default \'12:00\' '),
			'prescription' => array('appgini' => 'VARCHAR(40) '),
			'diagnosis' => array('appgini' => 'VARCHAR(40) '),
			'comments' => array('appgini' => 'TEXT ')
		)
	);
