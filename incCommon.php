<?php
	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(   
			'patients' => array('Pacientes', '', 'resources/table_icons/h.png', 'None'),
			'disease_symptoms' => array('Recetar', '', 'resources/table_icons/health.png', 'None'),
			'medical_records' => array('Registros médicos', '', 'resources/table_icons/cash_terminal.png', 'None'),
			'events' => array('Diagnósticos', '', 'table.gif', 'None')
		);
	...
	function get_defaults($table){
		...
		$defaults = array(
			'patients' => array(
				...
				'work_phone' => '',
				'mobile' => '',
				'tobacco_usage' => 'Desconocido',
				'alcohol_intake' => 'Desconocido',
				'history' => 'Desconocido',
				'surgical_history' => '',
				'obstetric_history' => '',
				'genetic_diseases' => '',
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> Teleconsultorio</a>
			</div>
